...
function TechSection() {
    ...
    return (
        <TechSectionStyle id={"tech_section"} className={"flex flex-col lg:flex-row p-10 lg:p-48 pt-36 lg:pt-48"}>
            <div className="header w-full h-full flex flex-col justify-center">
                <h2 className={"text-3xl lg:max-w-md my-4 z-10"}>What are my Programming Skills</h2>
            ...
            <div className="skill-list w-full h-full flex flex-col justify-center">
                <div className="list grid grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 w-full">
